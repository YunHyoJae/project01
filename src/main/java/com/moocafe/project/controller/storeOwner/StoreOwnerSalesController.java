...
public class StoreOwnerSalesController {
    ...
    public String viewSalesList(@AuthenticationPrincipal CustomUserDetails userDetails,
                                ...
                                Model model) {
        Integer memberId = userDetails.getLoggedMember().getId();
        ...
        List<SalesSummaryDto> summaryList = salesService.getSalesMenuSummary(storeId, startDate, endDate, menuName);
    ...
    public String registerSale(@ModelAttribute SaleRegisterDto dto,
        ...
        List<Menu> menuItems = menuService.findByMenuIdWithPrice(dto.getMenuId());
        ...
        for (Menu item : menuItems) {
            ...
            int currentStock = inventoryStoreService.findQuantityByStoreIdAndItemCode(dto.getStoreId(), item.getItemCode());
            ...
            inventoryStoreService.decreaseStock(dto.getStoreId(), item.getItemCode(), totalUsed);
        }
